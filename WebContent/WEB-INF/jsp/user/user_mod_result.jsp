	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dd><a href="<%=request.getContextPath() %>/user/checkMyInfo?Id=${s_user.id }">Information</a></dd>
				<dt>Order Management</dt>
				<dd><a href="<%=request.getContextPath() %>/user/checkMyOrder?Id=${s_user.id }">Order</a></dd>
			</dl>
		</div>
	</div>
	<div class="main">
				...
				<div class="box">
					<div class="msg">
						...
						<script type="text/javascript">
							setTimeout("location.href='<%=request.getContextPath() %>/user/myInfo'", 1000);
						</script>
					</div>
				</div>
			</div>
