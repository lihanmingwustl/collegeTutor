...
function CheckItem(obj)
{
	...
	switch(obj.id) {
		case "userName":
			if(obj.value == "") {
				msgBox.innerHTML = "Username cannot be empty";
		...
		case "rePassWord":
			if(obj.value == "") {
				msgBox.innerHTML = "Confirm password cannot be empty";
				msgBox.className = "error";
				return false;
			} else if(obj.value != document.getElementById("passWord").value) {
				msgBox.innerHTML = "Two passwords are not the same";
				msgBox.className = "error";
				return false;
			}
			break;
		case "Realname":
			if(obj.value == "") {
				msgBox.innerHTML = "Realname cannot be empty";
				msgBox.className = "error";
				return false;
			}
			break;
		case "Salary":
			if(obj.value == "") {
				msgBox.innerHTML = "Salary cannot be empty";
				msgBox.className = "error";
				return false;
			}
			break;
		case "School":
			if(obj.value == "") {
				msgBox.innerHTML = "School cannot be empty";
				msgBox.className = "error";
				return false;
			}
			break;
		case "Major":
			if(obj.value == "") {
				msgBox.innerHTML = "Major cannot be empty";
				msgBox.className = "error";
				return false;
			}
			break;
		case "Telephone":
			if(obj.value == "") {
				msgBox.innerHTML = "Telephone cannot be empty";
				msgBox.className = "error";
				return false;
			}
			break;
