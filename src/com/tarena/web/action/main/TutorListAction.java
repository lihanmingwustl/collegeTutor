...
public class TutorListAction extends PageAction {
	...
	public String execute() throws Exception {
		...
		tutors = rDAO.findByCatId(c2, begin, size);
	...
	public List<RegInfo> getTutors() {
		return tutors;
	}

	public void setTutors(List<RegInfo> tutors) {
		this.tutors = tutors;
	}
